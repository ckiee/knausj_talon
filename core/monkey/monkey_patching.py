...
#     subprocess.Popen(
#         ["notify-send", "-t", "3000", "-u", "low", f'"{title}"', f'"{subtitle}"']
#     )
...
#     out = None
#     try:
#         out = subprocess.check_output("which notify-send", shell=True)
#     except subprocess.CalledProcessError:
#         print("WARNING: notify-send not found. Skipping monkey patch")
#     if out:
#         print("Installing fidget notify-send notify monkey patch")
